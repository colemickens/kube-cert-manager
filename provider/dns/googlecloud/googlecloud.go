...
func NewDNSProvider(project string, serviceAccount []byte) (*DNSProvider, error) {
	jwtConfig, err := google.JWTConfigFromJSON(serviceAccount, dns.NdevClouddnsReadwriteScope)
	if err != nil {
		return nil, err
	}
